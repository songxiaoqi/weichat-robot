...
public final class WeChatClient {
    ...
    public WXContact getRandomWxContacts(){
        String[] strings = wxContacts.getContacts().keySet().toArray(new String[1]);
        return wxContacts.getContacts().get(strings[0]);
    }
