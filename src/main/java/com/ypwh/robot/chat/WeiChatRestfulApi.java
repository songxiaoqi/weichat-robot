...
import com.ypwh.robot.chat.commons.http.SHttpExecute;
import com.ypwh.robot.chat.commons.http.SRequest;
import com.ypwh.robot.chat.commons.http.impl.DefaultRequest;
import com.ypwh.robot.chat.commons.utils.STools;

/**
 * 微信api
 */
public class WeiChatRestfulApi {

    public static final String DEFAULT_WORKER = "";
    ...
    private final SHttpExecute httpExecute = XConfigTools.supply(WXHttpExecutor.class.getName());

    String host;
    String uin;
    String sid;
    String dataTicket;
    File folder = new File(DEFAULT_WORKER);
    ...
    String jslogin() {
        ...
        String rspStr = STools.http(httpExecutor, request).string();
